...
var fast_content_type_parse = __nccwpck_require__(927);
...
const rest_1 = __nccwpck_require__(894);
...
async function main() {
    ...
    const event = JSON.parse((0, node_fs_1.readFileSync)(process.env['GITHUB_EVENT_PATH'], 'utf8'));
    ...
    console.log(existing ? `Found existing nag comment (id: ${existing.id})` : 'No existing nag comment');
    if (passed) {
        if (existing) {
