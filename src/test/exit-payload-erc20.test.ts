...
describe('matic exit payload — ERC-20', function () {
  ...
  it('exit payload test', async function () {
    ...
    expect(result).to.include('ddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'); // Transfer sig
  ...
  it('exit payload with tokenIndex argument test', async function () {
    ...
    expect(result).to.include('ddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef');
