...
describe('invalid network param tests', function () {
  it('should 400 for `mainnet` on v1 block-included — msg contains network name', async function () {
  ...
  it('should 400 for `testnet` on v1 fast-merkle-proof — msg contains network name', async function () {
  ...
  it('should 400 for `mum` on v1 exit-payload — msg contains network name', async function () {
    const res = await getAgent().get(
  ...
  it('should 400 for `mainnet` on v1 all-exit-payloads — msg contains network name', async function () {
    const res = await getAgent().get(
  ...
  it('should 400 for `polygon` on zkEVM bridge — msg contains network name', async function () {
  ...
  it('should 400 for `polygon` on zkEVM merkle-proof — msg contains network name', async function () {
